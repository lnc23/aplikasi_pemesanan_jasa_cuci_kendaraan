...
class AdminDaftarPenyediaJasa extends StatelessWidget {
  AdminDaftarPenyediaJasa({Key? key}) : super(key: key);
          ...
          listener: (context, state) {
            if (state is AuthSuccessPenyedia) {
              Navigator.pushNamedAndRemoveUntil(
                  context, '/sign_up_penyedia', (route) => false);
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  backgroundColor: kBlackColor,
                  content: Text("Penyedia Jasa Berhasil Didaftarkan"),
                ),
              );
          ...
          builder: (context, state) {
            ...
            return CustomButton(
              ...
              onPressed: () {
                ...
                context.read<AuthCubit>().signUpPenyedia(
